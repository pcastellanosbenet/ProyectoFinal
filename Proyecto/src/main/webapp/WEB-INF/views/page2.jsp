...
<head>
  ...
  <link rel="stylesheet" href="resources/assets/gallery/style.css">
...
<body>
  <section class="menu cid-qTkzRZLJNu" once="menu" id="menu1-3">   
						...
						<div>
							<div>
								<div class="mbr-gallery-item mbr-gallery-item--p2"
									data-video-url="false" data-tags="Animada">
									<div href="#lb-gallery2-5" data-slide-to="0"
										data-toggle="modal">
										<img src="resources/assets/images/mbr-1920x1281-800x534.jpg" alt=""
											title=""> <span class="icon-focus"></span> <span
											class="mbr-gallery-title mbr-fonts-style display-7">Sueño
											hecho realidad</span>
									</div>
								</div>
								<div class="mbr-gallery-item mbr-gallery-item--p2"
									data-video-url="false" data-tags="Increíble">
									<div href="#lb-gallery2-5" data-slide-to="1"
										data-toggle="modal">
										<img src="resources/assets/images/mbr-5-1920x1280-800x533.jpg" alt=""
											title=""> <span class="icon-focus"></span> <span
											class="mbr-gallery-title mbr-fonts-style display-7">Lo
											bello de la vida</span>
									</div>
								</div>
								<div class="mbr-gallery-item mbr-gallery-item--p2"
									data-video-url="false" data-tags="Responsive">
									<div href="#lb-gallery2-5" data-slide-to="2"
										data-toggle="modal">
										<img src="resources/assets/images/mbr-1920x1279-800x533.jpg" alt=""
											title=""> <span class="icon-focus"></span> <span
											class="mbr-gallery-title mbr-fonts-style display-7">El
											descanso que mereces</span>
									</div>
								</div>
								<div class="mbr-gallery-item mbr-gallery-item--p2"
									data-video-url="false" data-tags="Animada">
									<div href="#lb-gallery2-5" data-slide-to="3"
										data-toggle="modal">
										<img src="resources/assets/images/mbr-1920x1277-800x532.jpg" alt=""
											title=""> <span class="icon-focus"></span> <span
											class="mbr-gallery-title mbr-fonts-style display-7">Ser
											feliz es lo que importa</span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="modal-body">
								<div class="carousel-inner">
									<div class="carousel-item">
										<img src="resources/assets/images/mbr-1920x1281.jpg" alt="" title="">
									</div>
									<div class="carousel-item active">
										<img src="resources/assets/images/mbr-5-1920x1280.jpg" alt="" title="">
									</div>
									<div class="carousel-item">
										<img src="resources/assets/images/mbr-1920x1279.jpg" alt="" title="">
									</div>
									<div class="carousel-item">
										<img src="resources/assets/images/mbr-1920x1277.jpg" alt="" title="">
									</div>
								</div>
								<a class="carousel-control carousel-control-prev" role="button"
									data-slide="prev" href="#lb-gallery2-5"><span
									class="mbri-left mbr-iconfont" aria-hidden="true"></span><span
									class="sr-only">Previous</span></a><a
									class="carousel-control carousel-control-next" role="button"
									data-slide="next" href="#lb-gallery2-5"><span
	...
	<section class="mbr-section content4 cid-rmYPu5iiTu" id="content4-6">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2">What is Lorem Ipsum?</h2>
                <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">Contrary to popular belief, Lorem Ipsum is not simply random text.&nbsp;</h3>
...
<section class="services1 cid-rmYRWUHGJp" id="services1-8">
    <!---->
        ...
        <div class="row justify-content-center">
            ...
            <div class="card col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="resources/assets/images/mbr-700x467.jpg" alt="Mobirise" title="">
                    </div>
                    <div class="card-box pb-md-5">
                        <h4 class="card-title mbr-fonts-style display-5">Star Room</h4>
            ...
            <div class="card col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="resources/assets/images/mbr-700x411.jpg" alt="Mobirise" title="">
                    </div>
                    <div class="card-box pb-md-5">
                        <h4 class="card-title mbr-fonts-style display-5">Special Room</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab accusantium dolores doloribus
                            eligendi eum illo placeat quis repellendus sequi tempore!
                        </p>
            ...
            <div class="card col-12 col-md-6 col-lg-4 last-child">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="resources/assets/images/mbr-1-700x467.jpg" alt="Mobirise" title="">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-5">Soft Room</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab accusantium dolores doloribus
                            eligendi eum illo placeat quis repellendus sequi tempore!
                        </p>
...
<section once="footers" class="cid-rmYUzUDuii" id="footer7-9"> 
    <div class="container">
        <div class="media-container-row align-center mbr-white">
            ...
            <div class="row row-copirayt">
                <p class="mbr-text mb-0 mbr-fonts-style mbr-white align-center display-7">I hope You like it.</p>
            </div>
        </div>
    </div>    
</section>
  ...
  <script src="resources/assets/bootstrapcarouselswipe/bootstrap-carousel-swipe.js"></script>
  <script src="resources/assets/vimeoplayer/jquery.mb.vimeo_player.js"></script>
  ...
  <script src="resources/assets/gallery/player.min.js"></script>
